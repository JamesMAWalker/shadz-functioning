...
export function Seo({
  ...
  return (
    <Helmet
      ...
      titleTemplate={`The Shadz | Eyewear Boutique`}
    >
      <html lang={hrefLang} />
      <meta
        name="google-site-verification"
        content="DLdMyvimc3swdZB5ZGSm11fhXhczEWz8FY5VHYaduEA"
      />
      ...
      />
      <link rel="apple-touch-icon" sizes="180x180" href="/favicon-reg.png" />
      {children}
    </Helmet>
  )
}
